...
class FeatureCore:
    ...
    def set_target_column(self, target_column: str | list[str]):
        ...
        if isinstance(target_column, str):
            ...
            cleaned_target_columns = [
                ...
                if col.strip()  # Turn selelcted columns into list format
            ]
        else:
        ...
        self.y = self.target_data[
            self.target_column
        ]  # Get target data columns and set as Y variable
    ...
    def set_feature_columns(self, feature_columns: list[str]):
        ...
        self.X = self.target_data[
            self.feature_columns
        ]  # Get target data columns and set as X variable
